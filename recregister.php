...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM recusers WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO recusers (username, password) VALUES (?, ?)";
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="wrapper">
        <h2>Sign Up</h2>
        <p>Please fill this form to create a Receptionist account.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a href="reclogin.php">Login here</a>.</p>
        </form>
    </div> 
